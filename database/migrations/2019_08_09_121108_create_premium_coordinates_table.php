...
class CreatePremiumCoordinatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('premium_coordinates', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('premium_coordinates');
    }
}
