...
class CreateStandardCoordinatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('standard_coordinates', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('standard_coordinates');
    }
}
